  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    std::wstring wstr;
    rosidl_typesupport_fastrtps_c::u16string_to_wstring(ros_message->bounded_wstring_value, wstr);
    cdr << wstr;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: bounded_wstring_value
  {
    ...
    std::wstring wstr;
    cdr >> wstr;
    bool succeeded = rosidl_typesupport_fastrtps_c::wstring_to_u16string(wstr, ros_message->bounded_wstring_value);
    if (!succeeded) {
      fprintf(stderr, "failed to create wstring from u16string\n");

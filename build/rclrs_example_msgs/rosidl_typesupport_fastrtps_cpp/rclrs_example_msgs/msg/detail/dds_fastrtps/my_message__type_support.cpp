  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    std::wstring wstr;
    rosidl_typesupport_fastrtps_cpp::u16string_to_wstring(ros_message.bounded_wstring_value, wstr);
    cdr << wstr;
  }
  ...
  // Member: bounded_short_values
  {
    ...
    if (size > 0) {
      cdr.serializeArray(&(ros_message.bounded_short_values[0]), size);
    }
  }
  ...
  rclrs_example_msgs::msg::MyMessage & ros_message)
{
  ...
  // Member: bounded_wstring_value
  {
    std::wstring wstr;
    cdr >> wstr;
    bool succeeded = rosidl_typesupport_fastrtps_cpp::wstring_to_u16string(wstr, ros_message.bounded_wstring_value);
    if (!succeeded) {
      fprintf(stderr, "failed to create wstring from u16string\n");
      return false;
    }
  ...
  // Member: bounded_short_values
  {
    ...
    if (size > 0) {
      cdr.deserializeArray(&(ros_message.bounded_short_values[0]), size);
    }
  }
